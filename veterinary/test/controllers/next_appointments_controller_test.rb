...
class NextAppointmentsControllerTest < ActionController::TestCase
  ...
  test "should create next_appointment" do
    assert_difference('NextAppointment.count') do
      post :create, next_appointment: { appointment_id: @next_appointment.appointment_id, date_of_appointment: @next_appointment.date_of_appointment, reason_for_visit: @next_appointment.reason_for_visit }
    end
  ...
  test "should update next_appointment" do
    patch :update, id: @next_appointment, next_appointment: { appointment_id: @next_appointment.appointment_id, date_of_appointment: @next_appointment.date_of_appointment, reason_for_visit: @next_appointment.reason_for_visit }
    assert_redirected_to next_appointment_path(assigns(:next_appointment))
  end
